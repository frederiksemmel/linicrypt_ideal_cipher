...
Now let $f$ be one of the 5 compression functions for we have found collisions only for different input lengths.  
...
\end{pchstack}
All are all inputs of the form $(x,x)$ collide under $\P_{\mathrm{collapse}}$.
