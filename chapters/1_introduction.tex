...
% TODO put this sentences in the preliminaries somewhere
% One defines a vector space where each vector capture the whole state of a Linicryp program.
% A variable can then be seen as a linear map from this vector space to its value for a specific execution of the program.
...
In order to do so, we make a set of definitions which differ slightly in the case of the random oracle and the ideal cipher.
